...
//	public static BlockHalfSlab slabModWood;
	...
	public static void initBlocks()
	{
		...
		marbleBrick = new ModBlocks(39, Material.rock).setModCreativeTab().setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("marbleBrick");
		basaltBrick = new ModBlocks(40, Material.rock).setModCreativeTab().setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("basaltBrick");
