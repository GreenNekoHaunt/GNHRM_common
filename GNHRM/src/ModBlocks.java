...
//	public static BlockHalfSlab slabModWood;
	...
	public static void initBlocks()
	{
		...
		marbleCobble = new ModBlocks(37, Material.rock).setModCreativeTab().setHardness(2.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("marbleCobble");
		basaltCobble = new ModBlocks(38, Material.rock).setModCreativeTab().setHardness(2.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("basaltCobble");
		...
		marbleBrick = new ModBlocks(39, Material.rock).setModCreativeTab().setHardness(3.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("marbleBrick");
		basaltBrick = new ModBlocks(40, Material.rock).setModCreativeTab().setHardness(3.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("basaltBrick");
		concrete = new ModBlocks(41, Material.rock).setModCreativeTab().setHardness(5.0F).setResistance(20.0F).setStepSound(soundStoneFootstep).setBlockName("concrete");
		granite = new ModBlocks(42, Material.rock).setModCreativeTab().setHardness(1.2F).setResistance(6.0F).setStepSound(soundStoneFootstep).setBlockName("granite");
		blockCopper = new ModBlocks(16, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockCopper");
		blockTin = new ModBlocks(17, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockTin");
		blockAluminium = new ModBlocks(18, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockAluminium");
		blockZinc = new ModBlocks(20, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockZinc");
		blockSilver = new ModBlocks(19, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockSilver");
		blockRuby = new ModBlocks(21, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockRuby");
		blockSapphire = new ModBlocks(22, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockSapphire");
		blockAmethyst = new ModBlocks(23, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockAmethyst");
		blockTopaz = new ModBlocks(24, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockTopaz");
		blockBrass = new ModBlocks(25, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockBrass");
		blockBronze = new ModBlocks(26, Material.iron).setModCreativeTab().setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockBronze");
		...
		cherryPlanks = new ModBlocks(66, Material.wood).setModCreativeTab().setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setBlockName("cherryPlanks").setRequiresSelfNotify();
		orangePlanks = new ModBlocks(69, Material.wood).setModCreativeTab().setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setBlockName("orangePlanks").setRequiresSelfNotify();
		...
		currantBranch = new ModBlockBranch(12, ModItems.currant).setCreativeTab((CreativeTabs)null).setBlockName("currantBranch");
		blackberryBranch = new ModBlockBranch(28, ModItems.blackberry).setCreativeTab((CreativeTabs)null).setBlockName("blackberryBranch");
		raspberryBranch = new ModBlockBranch(44, ModItems.raspberry).setCreativeTab((CreativeTabs)null).setBlockName("raspberryBranch");
		currantBush = new ModBlockBush(8, currantBranch, ModItems.currant).setModCreativeTab().setBlockName("currantBush");
		blackberryBush = new ModBlockBush(24, blackberryBranch, ModItems.blackberry).setModCreativeTab().setBlockName("blackberryBush");
		raspberryBush = new ModBlockBush(40, raspberryBranch, ModItems.raspberry).setModCreativeTab().setBlockName("raspberryBush");
