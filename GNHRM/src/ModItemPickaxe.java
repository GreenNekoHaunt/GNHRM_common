...
public class ModItemPickaxe extends ItemTool
{
	public static final Block[] blocksEffectiveAgainst = new Block[] {
		...
		ModBlocks.oreSilver, ModBlocks.oreAluminium, ModBlocks.oreSulphur, ModBlocks.oreUranium, ModBlocks.basalt, ModBlocks.marble,
		ModBlocks.oreRuby, ModBlocks.oreSapphire, ModBlocks.oreAmethyst, ModBlocks.oreTopaz};
