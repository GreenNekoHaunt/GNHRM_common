...
public class ModRecipes
{
    ...
    public static void initShapelessCraftingRecipes()
    {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(Block.stoneBrick, 1, 1), new ItemStack(ModBlocks.tallMoss, 3),
                                        new ItemStack(Block.stoneBrick, 1, 0));
        GameRegistry.addShapelessRecipe(new ItemStack(Block.cobblestoneMossy, 1), new ItemStack(ModBlocks.tallMoss, 3),
                                        Block.cobblestone);
    ...
    {
        recipeItems = new Object[]{ModItems.ingotCopper, ModItems.ingotTin, ModItems.ingotAluminium, ModItems.ingotZinc,
            ModItems.ingotSilver, ModItems.ingotBronze, ModItems.ingotBrass, ModItems.ruby, ModItems.sapphire,
            ModItems.amethyst, ModItems.topaz};
        recipeResults = new Object[][]{{ModBlocks.blockCopper, ModBlocks.blockTin, ModBlocks.blockAluminium,
            ModBlocks.blockZinc, ModBlocks.blockSilver, ModBlocks.blockBronze, ModBlocks.blockBrass, ModBlocks.blockRuby,
            ModBlocks.blockSapphire, ModBlocks.blockAmethyst, ModBlocks.blockTopaz}};
    ...
    {
        recipePatterns = new String[][]{
            {"x", "x", "y"}, {"x", "y", "y"}, {"xxx", " y ", " y "}, {"xx", "xy", " y"}, {"xx", " y", " y"}};
        recipeItems = new Object[]{ModItems.ingotCopper, ModItems.ingotTin, ModItems.ingotAluminium, ModItems.ingotZinc,
            ModItems.ingotSilver, ModBlocks.obsidian, ModItems.ingotBronze, ModItems.ingotBrass};
        recipeResults = new Object[][]{
        {ModItems.swordCopper, ModItems.swordTin, ModItems.swordAluminium, ModItems.swordZinc, ModItems.swordSilver,
         ModItems.swordObsidian, ModItems.swordBronze, ModItems.swordBrass},
        {ModItems.shovelCopper, ModItems.shovelTin, ModItems.shovelAluminium, ModItems.shovelZinc, ModItems.shovelSilver,
         ModItems.shovelObsidian, ModItems.shovelBronze, ModItems.shovelBrass},
        {ModItems.pickaxeCopper, ModItems.pickaxeTin, ModItems.pickaxeAluminium, ModItems.pickaxeZinc, ModItems.pickaxeSilver,
         ModItems.pickaxeObsidian, ModItems.pickaxeBronze, ModItems.pickaxeBrass},
        {ModItems.axeCopper, ModItems.axeTin, ModItems.axeAluminium, ModItems.axeZinc, ModItems.axeSilver,
         ModItems.axeObsidian, ModItems.axeBronze, ModItems.axeBrass},
        {ModItems.hoeCopper, ModItems.hoeTin, ModItems.hoeAluminium, ModItems.hoeZinc, ModItems.hoeSilver,
         ModItems.hoeObsidian, ModItems.hoeBronze, ModItems.hoeBrass}};
