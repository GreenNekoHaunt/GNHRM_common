...
public class ModItems extends Item
{
    ...
    public static Item pickaxeAluminium = new ModItemPickaxe(2, 2, ModEnumToolMaterial.ALUMINIUM)
            .setItemName("pickaxeAluminium");
    ...
    public static Item pickaxeObsidian = new ModItemPickaxe(5, 2, ModEnumToolMaterial.OBSIDIAN)
            .setItemName("pickaxeObsidian");
    ...
    public static Item ryeSeeds = new ModItemSeeds(0, 15, ModBlocks.ryeCrops.blockID, Block.tilledField.blockID)
            .setItemName("ryeSeeds");
    public static Item rice = new ModItemSeeds(1, 15, ModBlocks.riceCrops.blockID, Block.tilledField.blockID)
            .setItemName("riceSeeds");
    public static Item oat = new ModItemSeeds(2, 15, ModBlocks.oatCrops.blockID, Block.tilledField.blockID).setItemName("oat");
    public static Item barleySeeds = new ModItemSeeds(3, 15, ModBlocks.barleyCrops.blockID, Block.tilledField.blockID)
            .setItemName("barleyCrops");
