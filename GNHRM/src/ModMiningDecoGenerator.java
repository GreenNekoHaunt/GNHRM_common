...
public class ModMiningDecoGenerator
{
    ...
    {    
        ...
        {
            genLiquid(ModBlocks.oilFlowing.blockID, world, random, blockX + random.nextInt(16), random.nextInt(96),
        ...
        {    
            mudAmount = 30;
            genLiquid(ModBlocks.poisonWaterFlowing.blockID, world, random, blockX + random.nextInt(16), random.nextInt(128),
                        blockZ + random.nextInt(16));
            for(int var1 = 0; var1 < 3; var1++)
            {
                genLiquid(ModBlocks.poisonWaterFlowing.blockID, world, random, blockX + random.nextInt(16), random.nextInt(64),
                            blockZ + random.nextInt(16));
            }
        }
        genDeco(ModBlocks.marble.blockID, 48, 10, world, random, blockX + random.nextInt(16), random.nextInt(128),
                blockZ + random.nextInt(16));
        genDeco(ModBlocks.granite.blockID, 36, 8, world, random, blockX + random.nextInt(16), random.nextInt(128),
                blockZ + random.nextInt(16));
        genDeco(ModBlocks.mud.blockID, 32, mudAmount, world, random, blockX + random.nextInt(16), random.nextInt(128),
                blockZ + random.nextInt(16));
    }
    ...
    private static void genDecoCustom(int blockID, int replacedBlockId, int decoSize, int amount, World world, Random random,
